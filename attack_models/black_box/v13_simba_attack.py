...
Example:
    source venv_MM/bin/activate && python attack_models/black_box/v13_simba_attack.py --image_path data/clean/chart/20231114102825506748.png --epsilon 0.15 --max_iter 1000 --freq_dim 32 --ssim_threshold 0.85
"""
