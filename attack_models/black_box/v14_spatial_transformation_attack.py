...
Example:
    source venv_MM/bin/activate && python attack_models/black_box/v14_spatial_transformation_attack.py --image_path data/clean/chart/20231114102825506748.png --max_translation 3 --max_rotation 10 --max_scaling 0.1 --ssim_threshold 0.85
"""
