...
Example:
    source venv_MM/bin/activate && python attack_models/black_box/v16_zoo_attack.py --image_path data/clean/chart/20231114102825506748.png --confidence 0.0 --learning_rate 1e-2 --max_iter 10 --binary_search_steps 1 --initial_const 1e-3 --nb_parallel 128 --variable_h 1e-4 --ssim_threshold 0.85
"""
...
from v0_attack_utils import (
    ...
    apply_threshold_optimized_constraints, apply_standardized_ssim_constraint
)
