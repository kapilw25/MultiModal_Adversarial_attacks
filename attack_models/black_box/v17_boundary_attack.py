...
Example:
    source venv_MM/bin/activate && python attack_models/black_box/v17_boundary_attack.py --image_path data/clean/chart/20231114102825506748.png --delta 0.1 --epsilon 0.1 --max_iter 1000 --ssim_threshold 0.85
"""
