...
Example:
    source venv_MM/bin/activate && python attack_models/black_box/v18_geoda_attack.py --image_path data/clean/chart/20231114102825506748.png --norm 2 --sub_dim 10 --max_iter 1000 --ssim_threshold 0.85
"""
