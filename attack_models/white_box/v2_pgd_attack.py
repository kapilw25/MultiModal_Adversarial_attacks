...
Example:
    python v2_pgd_attack.py --image_path data/clean/chart/20231114102825506748.png --eps 0.02 --max_iter 50 --targeted_regions --perceptual_constraint --ssim_threshold 0.85
"""
