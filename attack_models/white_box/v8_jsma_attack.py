...
Example:
    python v8_jsma_attack.py --image_path data/clean/chart/20231114102825506748.png --max_iter 20 --theta 0.1 --max_pixel_change 10 --targeted_regions --perceptual_constraint
"""
