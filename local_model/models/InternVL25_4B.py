"""
Implementation of InternVL2_5-4B model with 4-bit quantization
...
class InternVL2_5_4BModelWrapper(BaseVLModel):
    """
    Wrapper class for InternVL2_5-4B model with optimized settings
    for memory-efficient inference on consumer GPUs.
    """
    
    def __init__(self, model_name="InternVL2_5-4B"):
        ...
        try:
            print(f"Loading InternVL2_5-4B model and tokenizer...")
            ...
            print(f"Error loading InternVL2_5-4B model: {e}")
            import traceback
            traceback.print_exc()
    ...
    def load_image(self, image_file):
        """Load and preprocess image for InternVL2_5-4B model"""
    ...
    def cleanup(self):
        ...
        print(f"Cleaning up InternVL2_5-4B resources...")
